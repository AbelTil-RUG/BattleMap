...
scoreboard players set max_tick_point_b settings 200
scoreboard players set mid_tick_point_b settings 100
scoreboard players set min_tick_point_b settings 0
scoreboard players set max_tick_point_c settings 200
scoreboard players set mid_tick_point_c settings 100
