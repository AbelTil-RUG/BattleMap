...
execute as @e[tag=control_point_a,tag=active,tag=!captured_blue] at @s if score point_a cap_state = max_tick_point_a settings run playsound minecraft:entity.experience_orb.pickup player @a[distance=..4,team=Blue]
execute if score point_a cap_state = max_tick_point_a settings as @e[tag=control_point_a,tag=!captured_blue] run tellraw @a {"text": "Point A is capped.", "color": "aqua"}
execute if score point_a cap_state = max_tick_point_a settings as @e[tag=control_point_a,tag=!captured_blue] run bossbar set point_a name {"text":"Point A","color":"aqua"}
execute if score point_a cap_state = max_tick_point_a settings as @e[tag=control_point_a,tag=!captured_blue] run bossbar set point_a color blue
execute if score point_a cap_state = max_tick_point_a settings as @e[tag=control_point_a,tag=!captured_blue] run tag @s add captured_blue
...
execute as @e[tag=control_point_a,tag=active,tag=!captured_red] at @s if score point_a cap_state = min_tick_point_a settings run playsound minecraft:entity.experience_orb.pickup player @a[distance=..4,team=Red]
execute if score point_a cap_state = min_tick_point_a settings as @e[tag=control_point_a,tag=!captured_red] run tellraw @a {"text": "Point A is capped.", "color": "red"}
execute if score point_a cap_state = min_tick_point_a settings as @e[tag=control_point_a,tag=!captured_red] run bossbar set point_a name {"text":"Point A","color":"red"}
execute if score point_a cap_state = min_tick_point_a settings as @e[tag=control_point_a,tag=!captured_red] run bossbar set point_a color red
execute if score point_a cap_state = min_tick_point_a settings as @e[tag=control_point_a,tag=!captured_red] run tag @s add captured_red
...
execute as @e[tag=control_point_b,tag=active,tag=!captured_blue] at @s if score point_b cap_state = max_tick_point_b settings run playsound minecraft:entity.experience_orb.pickup player @a[distance=..4,team=Blue]
execute if score point_b cap_state = max_tick_point_b settings as @e[tag=control_point_b,tag=!captured_blue] run tellraw @a {"text": "Point B is capped.", "color": "aqua"}
execute if score point_b cap_state = max_tick_point_b settings as @e[tag=control_point_b,tag=!captured_blue] run bossbar set point_b name {"text":"Point B","color":"aqua"}
execute if score point_b cap_state = max_tick_point_b settings as @e[tag=control_point_b,tag=!captured_blue] run bossbar set point_b color blue
execute if score point_b cap_state = max_tick_point_b settings as @e[tag=control_point_b,tag=!captured_blue] run tag @s add captured_blue
...
execute as @e[tag=control_point_b,tag=active,tag=!captured_red] at @s if score point_b cap_state = min_tick_point_b settings run playsound minecraft:entity.experience_orb.pickup player @a[distance=..4,team=Red]
execute if score point_b cap_state = min_tick_point_b settings as @e[tag=control_point_b,tag=!captured_red] run tellraw @a {"text": "Point B is capped.", "color": "red"}
execute if score point_b cap_state = min_tick_point_b settings as @e[tag=control_point_b,tag=!captured_red] run bossbar set point_b name {"text":"Point B","color":"red"}
execute if score point_b cap_state = min_tick_point_b settings as @e[tag=control_point_b,tag=!captured_red] run bossbar set point_b color red
execute if score point_b cap_state = min_tick_point_b settings as @e[tag=control_point_b,tag=!captured_red] run tag @s add captured_red
...
execute as @e[tag=control_point_c,tag=active,tag=!captured_blue] at @s if score point_c cap_state = max_tick_point_c settings run playsound minecraft:entity.experience_orb.pickup player @a[distance=..4,team=Blue]
execute if score point_c cap_state = max_tick_point_c settings as @e[tag=control_point_c,tag=!captured_blue] run tellraw @a {"text": "Point C is capped.", "color": "aqua"}
execute if score point_c cap_state = max_tick_point_c settings as @e[tag=control_point_c,tag=!captured_blue] run bossbar set point_c name {"text":"Point C","color":"aqua"}
execute if score point_c cap_state = max_tick_point_c settings as @e[tag=control_point_c,tag=!captured_blue] run bossbar set point_c color blue
execute if score point_c cap_state = max_tick_point_c settings as @e[tag=control_point_c,tag=!captured_blue] run tag @s add captured_blue
...
execute as @e[tag=control_point_c,tag=active,tag=!captured_red] at @s if score point_c cap_state = min_tick_point_c settings run playsound minecraft:entity.experience_orb.pickup player @a[distance=..4,team=Red]
execute if score point_c cap_state = min_tick_point_c settings as @e[tag=control_point_c,tag=!captured_red] run tellraw @a {"text": "Point C is capped.", "color": "red"}
execute if score point_c cap_state = min_tick_point_c settings as @e[tag=control_point_c,tag=!captured_red] run bossbar set point_c name {"text":"Point C","color":"red"}
execute if score point_c cap_state = min_tick_point_c settings as @e[tag=control_point_c,tag=!captured_red] run bossbar set point_c color red
execute if score point_c cap_state = min_tick_point_c settings as @e[tag=control_point_c,tag=!captured_red] run tag @s add captured_red
...
## Show owner
##################################################################################################################
execute at @e[tag=control_point,tag=active,tag=uncaptured] run function cp:particles/circle_grey
execute at @e[tag=control_point,tag=active,tag=captured_red] run function cp:particles/circle_red
execute at @e[tag=control_point,tag=active,tag=captured_blue] run function cp:particles/circle_blue
...
execute as @a[team=Blue,scores={died=1..},tag=in_arena] run scoreboard players operation Red tickets -= tickets_per_kill settings
execute as @a[team=Red,scores={died=1..},tag=in_arena] run scoreboard players operation Blue tickets -= tickets_per_kill settings
