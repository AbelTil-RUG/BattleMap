...
give @a[tag=bomber,tag=in_arena,level=100..,nbt=!{Inventory:[{tag:{Tags:["ultimate_item"]}}]}] trident{Unbreakable:1,Tags:["ultimate_item"],AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:4,Slot:mainhand,Name:"generic.attack_damage",UUID:[I;-123111,2743,203058,-5486]}],HideFlags:2} 1
