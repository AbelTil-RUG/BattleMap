...
scoreboard objectives add archer_arrow_used used:bow

scoreboard objectives add bomber_bob dummy
scoreboard objectives add bomber_bob_used minecraft.used:minecraft.creeper_spawn_egg
...
scoreboard objectives add sniper_carrot_used dummy
scoreboard objectives add sniper_fungus dummy
scoreboard objectives add sniper_fungus_used dummy
